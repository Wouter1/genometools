...
//			totalCount++;
	...
	void count(String iFile, int maxZoomValue, double minMapping)
			throws IOException, URISyntaxException {
		setNZoom(maxZoomValue);
		setTrackParameters("SENSEAWARECOVERAGE", null,
				new String[] { "firstforward", "firstreverse", "secondforward",
						"secondreverse" });
